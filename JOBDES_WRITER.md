# 📝 JOB DESCRIPTION - TIM WRITER (LAPORAN)
## KKL - Teknik Informatika UNISNU Jepara 2026
...
## 🎯 SAAT KUNJUNGAN (19-21 JANUARI 2026)

### **YANG HARUS DILAKUKAN:**

#### 1. CATAT SEMUA INFORMASI PENTING

**Di IDX Bursa Efek Surabaya (19 Jan):**
- [ ] **Catat nama narasumber & jabatan**
...
**Kegiatan Lainnya:**
- [ ] **Catat jadwal kegiatan** (Jatim Park, ziarah, dll)
- [ ] **Catat kesan & pembelajaran**
...
- [ ] Foto di depan gedung IDX
- [ ] Foto narasumber saat presentasi
- [ ] Foto peserta mendengarkan
...
## 📝 SETELAH KKL (22 JANUARI - 11 FEBRUARI)

### **YANG HARUS DIBUAT:**

#### **BAB I - PENDAHULUAN** (2-3 halaman)

**A. Latar Belakang:**
- [ ] Tulis kenapa KKL penting untuk mahasiswa TI
- [ ] Tulis tentang KKL sebagai mata kuliah wajib
- [ ] Tulis tentang kesempatan belajar dari industri
- [ ] Tulis tentang laporan ini

**B. Tujuan:**
- [ ] Tulis 5-6 poin tujuan KKL
- [ ] Pakai numbering (1, 2, 3, ...)

---

#### **BAB II - PELAKSANAAN** (4-6 halaman)

**A. Pembekalan (0.5-1 halaman):**
- [ ] Tulis tanggal, tempat, waktu
- [ ] Tulis materi pembekalan (singkat)
- [ ] Tulis pesan dari panitia
- [ ] Tempel foto pembekalan
...
**C. KKL di UNISMA (0.5-1 halaman) - SINGKAT!:**
- [ ] Tulis tanggal & kegiatan
- [ ] Tulis materi yang disampaikan (ringkas)
- [ ] Tempel foto di UNISMA

**D. Kegiatan Penutupan (0.5-1 halaman):**
- [ ] Tulis kegiatan hari ke-3:
  - Jatim Park 3
  - Senam/ice breaking
  - Belanja oleh-oleh
...
- [ ] Tulis tentang sharing session
- [ ] Tulis pembelajaran yang didapat

---

#### **BAB IV - PENUTUP** (2-3 halaman)

**A. Kesimpulan (1-1.5 halaman):**
- [ ] Tulis kesimpulan tentang IDX
- [ ] Tulis kesimpulan tentang teknologi
- [ ] Tulis kesimpulan tentang peluang karir
- [ ] Tulis kesimpulan tentang pembelajaran

**B. Saran (1-1.5 halaman):**
- [ ] Tulis saran untuk panitia KKL
- [ ] Tulis saran untuk prodi TI
- [ ] Tulis saran untuk mahasiswa
- [ ] Tulis saran untuk IDX & UNISMA

---

#### **DAFTAR GAMBAR:**
- [ ] Arrange foto-foto dengan rapi
- [ ] Kasih caption setiap foto
- [ ] Format: "Gambar X. [Deskripsi]"
...
### **Minggu 2 (29 Jan - 4 Feb):**
- [ ] Draft BAB III & IV (100%)
- [ ] Revisi BAB I & II

### **Minggu 3 (5-11 Feb):**
- [ ] Compile semua BAB
- [ ] Proofread & arrange foto
- [ ] Print & jilid
- [ ] SUBMIT!
...
- **Spasi:** 1.5 (isi), 1 (kata pengantar)
- **Margin:** 4-4-3-3 cm
- **Jilid:** Sampul merah tua laminasi
...
### DO's ✅
- Catat dengan detail saat kunjungan
...
### DON'Ts ❌
- Jangan nunda-nunda
- Jangan lupa catat nama narasumber
- Jangan lupa foto dokumentasi
- Jangan plagiat
...
**Laporan Final:**
- Halaman: 15-20 halaman
- Format: Sesuai panduan kampus
- Isi: Berkualitas & informatif
- Nilai: A! 📚✨
